...
export PS1="\[$(tput bold)\]\[$(tput setaf 2)\]\w\[$(tput setaf 6)\] \$(git branch 2> /dev/null | sed -e '/^[^*]/d' -e 's/* \(.*\)/(\1)/')> \[$(tput setaf 7)\]\[$(tput sgr0)\]"
...
HISTSIZE=1000
HISTFILESIZE=2000
# ignoreboth – Enable both ignoredups and ignorespace. erasedups- eliminate duplicates from the whole list
# ignorespace – eliminates commands that begin with a space history list. ignoredups – eliminate duplicate commands.
...
#    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\[\033[01;34m\]\w\[\033[01;34m\] > \033[00m\]'
#else
...
# Source FFF - fucking fast file-manager
if [ -f ~/.fffrc ]; then
    . ~/.fffrc
fi
