...
static const char *fmcmd[] = { "st", "-e", "fff", NULL };
static const char *mountdevicecmd[] = { "udevil-mounter", "-m", NULL };
static const char *umountdevicecmd[] = { "udevil-mounter", "-u", NULL };
static const char *passcmd[] = { "passmenu", "--type", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_p,      spawn,          {.v = passcmd } },
	{ MODKEY|ShiftMask,             XK_m,      spawn,          {.v = mountdevicecmd } },
	{ MODKEY|ShiftMask,             XK_u,      spawn,          {.v = umountdevicecmd } },
